			...
			<form role='form' method="POST" action='{{ url("admin/empleados/{$empleado->id}") }}'>
				...
				<div class="row">
					...
					<div class="form-group col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="form-check">
                            ...
                            <input type="radio" name="sexo" class="form-check-input" value="hombre" id="hombre" {{ $empleado->sexo == 'hombre' ? 'checked' : '' }}>                    
                        ...
                        <div class="form-check">
                            ...
                            <input type="radio" name="sexo" class="form-check-input" value="mujer" id="mujer" {{ $empleado->sexo == 'mujer' ? 'checked' : '' }}>                    
				...
				<div class="row">
					...
					<div class="form-group col-sm-12 col-md-12 col-lg-6">
                        ...
                        <input id="email-confirm" type="email" placeholder="" class="form-control" name="email_confirmation" value="{{ old('email-confirm' , $empleado->email) }}">
