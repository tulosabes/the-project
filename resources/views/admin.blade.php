...
@if (Auth::user()->id_rol == 1)
    ...
    @section('navLiIzq')
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('perfiles.index') }}"><span class="oi oi-person"></span> Perfil <span class="sr-only">(current)</span></a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('club.index') }}"><span class="oi oi-home"></span> Club</a></li>
    ...
    @section('navLiDer')
        ...
        <li class="nav-item ml-auto"><a href="{{ route('perfiles.index') }}" class="nav-link">Bienvenido {{ Auth::user()->name }}!!!</a></li>
