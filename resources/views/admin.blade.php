...
@if (Auth::user()->id_rol == 1)
    ...
    @section('navLiIzq')
        <!--<li class="nav-item"><a class="nav-link" href="{{ route('perfiles.index') }}">Home</a></li>-->
        <li class="nav-item active"><a class="nav-link" href="{{ route('perfiles.index') }}"><span class="oi oi-person"></span> Perfil <span class="sr-only">(current)</span></a></li>
