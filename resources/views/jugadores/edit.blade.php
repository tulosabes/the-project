			...
			<form role='form' method="POST" action='{{ url("admin/jugadores/{$jugador->id}") }}'>
				...
				<div class="row">
					...
					<div class="form-group col-sm-12 col-md-4 col-lg-4">
                        ...
                        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento', $jugador->fecha_nacimiento) }}" max="{{ $date->now()->subYears(14)->formatLocalized('%Y-%m-%d') }}">
				...
				<div class="row">
					...
					<div class="form-group col-sm-12 col-md-12 col-lg-6">
                        ...
                        <input id="email-confirm" type="email" placeholder="" class="form-control" name="email_confirmation"  value="{{ old('email-confirm' , $jugador->email) }}">
